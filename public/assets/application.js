...
/*!
 * Bootstrap v3.1.1 (http://getbootstrap.com) lalala,sjnchbd
 ...
 *
 * $Id: jquery.validate.js,v 1.6 2011-03-28 22:07:12 graciela_colmenares Exp $
 *
...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Invalid Email.",
		rif: "Invalid Rif. Ej: J-12345678-9",
		tel: "Invalid Telephone. Ej: 0251-4424023",
		...
		maxlength: $.validator.format("Escriba máximo {0} carácteres."),
		minlength: $.validator.format("Please enter at least {0} characters."),
		rangelength: $.validator.format("Please enter a value between {0} and {1} characters long."),
		range: $.validator.format("Please enter a value between {0} and {1}."),
		max: $.validator.format("Please enter a value less than or equal to {0}."),
		min: $.validator.format("Please enter a value greater than or equal to {0}."),
		listacorreo: "Ingrese una lista de correo válida, separando cada correo por punto y coma(;)"
	},
	...
	classRuleSettings: {
		...
		email: {email: true},
		validarif: {validarif: true},
		validatel: {validatel: true},
		listacorreo: {validatel: true},
		validaletras: {validaletras: true},
		url: {url: true},
		date: {date: true},
	...
	methods: {
		...
		validarif: function(value, element) {
			// contributed by Enderson Castillo
			return this.optional(element) || /^(([a-z]|[A-Z])\-[0-9]+\-[0-9])$/.test(value);
		},
		
		validatel: function(value, element) {
			// contributed by Enderson Castillo. Format: 0251-442.40.23
			//return this.optional(element) || /^\d{4}-\d{3}\.\d{2}\.\d{2}$/.test(value);
			// contributed by Enderson Castillo. Format: 0251-4424023
			return this.optional(element) || /^\d{4}-\d{7}$/.test(value);
		},
		listacorreo: function(value, element) {
			// contributed by Graciela Colmenares and Alfonso Licir Format: alfonso.licir@gmail.com;graciela.colmenares@dbaccess.com;
			//return this.optional(element) || /^((((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))\;)+$/i.test(value);
		...
		validaletras: function(value, element) {
			// contributed by Enderson Castillo. Acepta formatos acepta letras mayusculas, minusculas y acentuadas
