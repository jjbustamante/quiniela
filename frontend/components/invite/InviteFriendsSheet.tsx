      ...
      >
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={copy}
            className="flex-1 rounded-md border border-[var(--color-accent-cyan)] py-3 text-sm font-semibold uppercase tracking-wider text-[var(--color-accent-cyan)] hover:bg-[var(--color-accent-cyan)]/10"
          >
          ...
          <a
            ...
            className="flex flex-1 items-center justify-center gap-2 rounded-md bg-[#25d366] py-3 text-sm font-semibold uppercase tracking-wider text-black hover:opacity-90"
          >
